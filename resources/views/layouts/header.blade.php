  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown">
      <a class="nav-link d-flex align-items-center text-white" data-toggle="dropdown" href="#" role="button">
        <img src="{{ asset('adminlte/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2 mr-2" alt="User Image" width="30" height="30">
        <span class="d-none d-md-inline">Anas Nurhidayat</span>
