<div class="modal-header bnn-header text-white">
  <h5 class="modal-title font-weight-bold">
    <i class="fas fa-plus-circle mr-2"></i> Tambah Jabatan Referensi
  </h5>
...
<form id="formCreateJabatan" enctype="multipart/form-data">
  @csrf
      ...
      <div class="col-12 bnn-section">
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="nama_jabatan" class="form-control" placeholder="Contoh: Analis Kepegawaian" required>
            @error('nama_jabatan')
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="eselon" class="form-control" placeholder="Contoh: II.a">
            @error('eselon')
              <div class="text-danger small">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="form-group">
          ...
          <textarea name="keterangan" class="form-control" rows="3" placeholder="Tambahkan keterangan jabatan..."></textarea>
          @error('keterangan')
            <div class="text-danger small">{{ $message }}</div>
          @enderror
        </div>
