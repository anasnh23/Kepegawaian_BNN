...
<div class="container-fluid">
    <h4 class="mb-3">Data Presensi Pegawai</h4>
                    ...
                    <td>
                        @if($row->foto_masuk)
                            <a href="{{ asset('storage/presensi/'.$row->foto_masuk) }}" target="_blank">
                                <img src="{{ asset('storage/presensi/'.$row->foto_masuk) }}" width="60">
                            </a>
                        @else
                    ...
                    <td>
                        @if($row->foto_pulang)
                            <a href="{{ asset('storage/presensi/'.$row->foto_pulang) }}" target="_blank">
                                <img src="{{ asset('storage/presensi/'.$row->foto_pulang) }}" width="60">
                            </a>
                        @else
                            <span class="text-muted">-</span>
                        @endif
...
<!-- Tambahkan jQuery & Datatables jika perlu -->
@push('scripts')
